module SavvyScoreHelper
	...
	def investment_feedback
		...
		elsif((@savvy_score_user.investment_types['stock_funds'] == 1) && (@savvy_score_user.investment_types['retirement_funds'] == 0))
			"Great that you're doing some investing! You may want to consider investing in a retirement fund as well, 
			but we can talk more about that later."
		elsif((@savvy_score_user.investment_types['indiv_stocks'] == 1) && (@savvy_score_user.investment_types['retirement_funds'] == 0) && (@savvy_score_user.investment_types['stock_funds'] == 0))
		...
		elsif((@savvy_score_user.investment_types['real_estate'] == 1) && (@savvy_score_user.investment_types['retirement_funds'] == 0))
