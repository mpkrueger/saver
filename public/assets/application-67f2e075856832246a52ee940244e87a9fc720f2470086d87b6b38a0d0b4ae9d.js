  ...
  $(document).on('ready turbolinks:load', function(event) {
    ...
    $('#500').change(function() {
      ...
      if (has_500 === 'Yes, I do') {
        ...
        $('#depends-choice').show();
        return $('#depends-choice').change(function() {
          var invest;
    ...
    $('#savings-purpose').change(function() {
      var savingspurpose;
    ...
    $('#selected-pig').hide();
    $('#unselected-pig').click(function() {
      if ($('#unselected-pig').is(':visible')) {
        $('#unselected-pig').hide();
        return $('#selected-pig').show();
      }
    });
    $('#selected-pig').click(function() {
      if ($('#selected-pig').is(':visible')) {
        $('#selected-pig').hide();
        return $('#unselected-pig').show();
      }
    });
    $('#spacing').hide();
    $('#matching').hide();
    ...
    return $('#401k').change(function() {
      ...
      if (has_401k === 'offers a 401k') {
        ...
        $('#spacing').show();
        $('#matching').show();
        return $('#matching').change(function() {
          var matches;
...
(function() {
  $(document).on('ready turbolinks:load', function(event) {
    ...
    $('#NextButton').hide();
    $('#savings-amount').change(function() {
      var has_savings;
    ...
    $('#none').hide();
    $('#NextButton').hide();
    return $('#savings-habits').change(function() {
      var savings_habits;
